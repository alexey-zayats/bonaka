...
{
public:
	DockWidget(QWidget *inner, MainWindow *parent);
...
DockWidget::DockWidget(QWidget *inner, MainWindow *parent)
...
/*! \class Utils::MainWindow

	\brief The MainWindow class is a MainWindow with dock widgets and
...
MainWindowPrivate::MainWindowPrivate(MainWindow *parent) :
	...
	m_menuSeparator1(0),
	m_menuSeparator2(0),
	m_resetLayoutAction(MainWindow::tr("Reset to Default Layout"), 0),
	m_autoHideTitleBars(MainWindow::tr("Automatically Hide View Title Bars"), 0)
{
...
MainWindow::MainWindow(QWidget *parent) :
	QMainWindow(parent), d(new MainWindowPrivate(this))
{
...
QDockWidget *MainWindow::addDockForWidget(QWidget *widget)
{
	...
	connect(dockWidget->toggleViewAction(), &QAction::triggered,
			this, &MainWindow::onDockActionTriggered,
			Qt::QueuedConnection);
...
void MainWindow::onDockActionTriggered()
{
...
void MainWindow::restoreSettings(const QSettings *settings)
{
...
QHash<QString, QVariant> MainWindow::saveSettings() const
{
...
void MainWindow::restoreSettings(const QHash<QString, QVariant> &settings)
{
...
bool MainWindow::autoHideTitleBars() const
{
...
void MainWindow::addDockActionsToMenu(QMenu *menu)
{
...
QAction *MainWindow::menuSeparator1() const
{
	return &d->m_menuSeparator1;
}

QAction *MainWindow::autoHideTitleBarsAction() const
{
	return &d->m_autoHideTitleBars;
}

QAction *MainWindow::menuSeparator2() const
{
	return &d->m_menuSeparator2;
}

QAction *MainWindow::resetLayoutAction() const
{
	return &d->m_resetLayoutAction;
}

void MainWindow::setDockActionsVisible(bool v)
{
